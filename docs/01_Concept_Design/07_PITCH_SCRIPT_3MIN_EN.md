# ChoonSim-Talk — 3-Minute Pitch Script (English)
> Created: 2026-04-26
> Last Updated: 2026-04-26
> Format: 3-Minute VO Script (ElevenLabs Ready)
> Target: Colosseum Frontier Hackathon 2026 (Apr 6 – May 11)
> Word Count: ~420 words / ~3:00 at 130 wpm

---

## Usage Notes

- `[SLIDE N]` 마커는 슬라이드 전환 타이밍 참고용 — ElevenLabs 입력 시 제거
- `[▶ DEMO VIDEO]` 구간은 영상 재생 중 VO가 계속 흐름 — 영상과 싱크 맞춰 편집
- ElevenLabs 추천 설정: Voice `Rachel` or `Aria` / Stability `0.55` / Similarity `0.75` / Style `0.20` / Speed `0.90`
...
| 구간 | 슬라이드 | 시간 | 내용 |
|------|---------|------|------|
| Opening | Slide 1 | 0:00 – 0:18 | 태그라인 + 훅 |
| Problem | Slide 2 | 0:18 – 0:35 | Cold Start Problem |
| Insight | Slide 3 | 0:35 – 0:52 | Dunbar + 공감 차별화 |
| Solution | Slide 4 | 0:52 – 0:56 | 한 줄 전환 |
| Why Solana | Slide 4 | 0:56 – 1:20 | Blinks/cNFT/Token-2022 — Web2→Web3 브릿지 |
| Demo 1 | (영상) | 1:20 – 2:05 | ChoonSim-Talk 시연 (CHOCO 구매 + cNFT + Blink) |
| CTA | — | 2:05 – 2:15 | "Try it yourself" + 0.5 SOL 자동 지급 안내 |
| Traction + Demo 2 | Slide 10 + (영상) | 2:15 – 2:28 | 팬메일 대시보드 + 성장 데이터 |
| Business | Slide 9 | 2:28 – 2:42 | Character-Fi 수익모델 |
| Roadmap | Slide 11 | 2:42 – 2:52 | 완료 + 다음 단계 |
| Closing | Slide 12 | 2:52 – 3:00 | Why Solana 재강조 + 감사 |

---

## 한국어 스크립트 (Korean Version)

> 발음 자연스러운 한국어 발표용 — 약 3분 / ~400자
...
웹3만의 고립된 기술만으로는 대중의 벽을 넘을 수 없습니다.
우리가 넘어야 할것은 기술이 아니라 사람일지도 모릅니다.

X에서 춘심이를 사랑하는 33,000명의 실제 팬들,
단 한 번도 블록체인을 만져본 적 없는 사람들과 함께 시작합니다.

그리고 Solana의 기술들이 그들을
눈치채지 못하게, 마찰 없이, 온체인으로 데려옵니다.

이것이 우리가 Solana를 선택한 이유입니다.
...
지갑 설정도, 앱 다운로드도 필요 없습니다.
소셜 피드가 Solana 트랜잭션 레이어가 됩니다.
...
비즈니스 모델은 우리가 Character-Fi라고 부르는 것입니다.

다섯 가지 수익원:
CHOCO 토큰 구매, 기억 각인 수수료,
구독 NFT, 자동 전송 수수료 —
그리고 한정 캐릭터 컬렉터블.
...
오늘날 수억 명의 팬들이 Web2에 살고 있습니다.
그들은 팔로우하고, 사랑하고, 연결됩니다.

춘심이를 사랑하는 모든 팬이
자신도 모르는 사이에 이미 Web3로 들어오고 있습니다.
그들의 기억은 온체인에 있습니다.
그들의 충성심은 실제 가치를 가집니다.

Solana가 그것을 바꾸고 있습니다.

이것은 Web3가 세상을 쫓아가는 것이 아닙니다.
세상이 Web3로 오는 것입니다.
...
## Related Documents
- **Concept_Design**: [Colosseum Pitch Deck](./04_COLOSSEUM_PITCH_DECK.md) — 12슬라이드 상세 내용 및 스크립트 원본
- **Concept_Design**: [Core Pitch Deck](./01_CORE_PITCH_DECK.md) — 철학적 기반
- **QA_Validation**: [Pitch Q&A Prep](../05_QA_Validation/02_PITCH_QA_PREP.md) — 예상 질문 대비
